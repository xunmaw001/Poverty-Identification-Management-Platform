...
public class PinkuhushenqingView extends PinkuhushenqingEntity implements Serializable {
	...
	public PinkuhushenqingView() {

	}

	public PinkuhushenqingView(PinkuhushenqingEntity pinkuhushenqingEntity) {
		try {
			BeanUtils.copyProperties(this, pinkuhushenqingEntity);
