...
public class DanshengongdanYiView extends DanshengongdanYiEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String danshengongdanYiYesnoValue;
	...
	public DanshengongdanYiView() {

	}

	public DanshengongdanYiView(DanshengongdanYiEntity danshengongdanYiEntity) {
		try {
			BeanUtils.copyProperties(this, danshengongdanYiEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getDanshengongdanYiYesnoValue() {
				return danshengongdanYiYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setDanshengongdanYiYesnoValue(String danshengongdanYiYesnoValue) {
				this.danshengongdanYiYesnoValue = danshengongdanYiYesnoValue;
			}
