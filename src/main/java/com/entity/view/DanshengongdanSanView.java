...
public class DanshengongdanSanView extends DanshengongdanSanEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String danshengongdanSanYesnoValue;
	...
	public DanshengongdanSanView() {

	}

	public DanshengongdanSanView(DanshengongdanSanEntity danshengongdanSanEntity) {
		try {
			BeanUtils.copyProperties(this, danshengongdanSanEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getDanshengongdanSanYesnoValue() {
				return danshengongdanSanYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setDanshengongdanSanYesnoValue(String danshengongdanSanYesnoValue) {
				this.danshengongdanSanYesnoValue = danshengongdanSanYesnoValue;
			}
