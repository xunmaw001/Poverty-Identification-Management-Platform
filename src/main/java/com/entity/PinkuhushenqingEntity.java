...
public class PinkuhushenqingEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public PinkuhushenqingEntity() {

	}

	public PinkuhushenqingEntity(T t) {
		try {
    ...
    public String toString() {
        return "Pinkuhushenqing{" +
            "id=" + id +
            ", yonghuId=" + yonghuId +
            ", pinkuhushenqingUuidNumber=" + pinkuhushenqingUuidNumber +
            ", pinkuhushenqingName=" + pinkuhushenqingName +
            ", sexTypes=" + sexTypes +
            ", age=" + age +
            ", zhengzhiTypes=" + zhengzhiTypes +
            ", pinkuhushenqingShenfenzhengPhone=" + pinkuhushenqingShenfenzhengPhone +
            ", pinkuhushenqingShenfenzhengIdNumber=" + pinkuhushenqingShenfenzhengIdNumber +
            ", pinkuhushenqingShenfenzhengRenxiangPhoto=" + pinkuhushenqingShenfenzhengRenxiangPhoto +
            ", pinkuhushenqingShenfenzhengGuohuiPhoto=" + pinkuhushenqingShenfenzhengGuohuiPhoto +
            ", pinkuhushenqingShenqingTypes=" + pinkuhushenqingShenqingTypes +
            ", pinkuhushenqingJuweihuiFile=" + pinkuhushenqingJuweihuiFile +
            ", pinkuhushenqingContent=" + pinkuhushenqingContent +
            ", insertTime=" + insertTime +
            ", pinkuhushenqingYiJieguo=" + pinkuhushenqingYiJieguo +
            ", pinkuhushenqingYiYijian=" + pinkuhushenqingYiYijian +
            ", pinkuhushenqingYiTime=" + pinkuhushenqingYiTime +
            ", pinkuhushenqingErJieguo=" + pinkuhushenqingErJieguo +
            ", pinkuhushenqingErYijian=" + pinkuhushenqingErYijian +
            ", pinkuhushenqingErTime=" + pinkuhushenqingErTime +
            ", pinkuhushenqingSanJieguo=" + pinkuhushenqingSanJieguo +
            ", pinkuhushenqingSanYijian=" + pinkuhushenqingSanYijian +
            ", pinkuhushenqingSanTime=" + pinkuhushenqingSanTime +
